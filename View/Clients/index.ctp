<div class="clients index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('email_2');?></th>
			<th><?php echo $this->Paginator->sort('annonymous');?></th>
	...
	<tr>
		...
		<td><?php echo h($client['Client']['address_line_1']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['address_line_2']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['address_line_3']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['address_line_4']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['post_code']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['phone_1']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['phone_2']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['email_1']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['email_2']); ?>&nbsp;</td>
		<td><?php echo h($client['Client']['annonymous']); ?>&nbsp;</td>
		<td class="actions">
