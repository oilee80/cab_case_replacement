...
// Gets any messages set using Session->setFlash
...
// Customised render method to output SQL_dump if in Degub Level 2
				if(class_exists('ConnectionManager') && Configure::read('debug') == 2) {
/* Copied from Elements/sql_dump.ctp */
					$noLogs = !isset($logs);
					if ($noLogs):
					...
					foreach ($logs as $source => $logInfo):
						...
						$summary = sprintf('(%s) %s %s took %s ms', $source, $logInfo['count'], $text, $logInfo['time']);
