<div class="contactTypes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('cab_code');?></th>
	...
	<tr>
		...
		<td><?php echo h($contactType['ContactType']['title']); ?>&nbsp;</td>
		<td><?php echo h($contactType['ContactType']['cab_code']); ?>&nbsp;</td>
		<td><?php echo h($contactType['ContactType']['disabled']); ?>&nbsp;</td>
		<td class="actions">
